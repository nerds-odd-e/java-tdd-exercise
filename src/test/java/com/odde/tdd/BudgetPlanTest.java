...
public class BudgetPlanTest {
    ...
    public void no_budget() {
        givenBudgets();
        assertEquals(0, plan.query(LocalDate.of(2019, 10, 4), LocalDate.of(2019, 11, 4)));
    }
    ...
    public void query_after_budget() {
        givenBudgets(new Budget(YearMonth.of(2019, 10), 3100));
        assertEquals(700, plan.query(LocalDate.of(2019, 10, 25), LocalDate.of(2019, 11, 4)));
    }

    @Test
    public void query_out_of_budget() {
        givenBudgets(new Budget(YearMonth.of(2019, 10), 3100));
        assertEquals(0, plan.query(LocalDate.of(2019, 9, 2), LocalDate.of(2019, 9, 4)));
    }
    ...
    public void query_multiple_budgets() {
        ...
        assertEquals(3000 + 40, plan.query(LocalDate.of(2019, 10, 2), LocalDate.of(2019, 11, 4)));
    }
